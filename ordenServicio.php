...
<div id="divBotones">
	<input type="button" value="Ordenes de Servicio" onclick="window.location = 'oss.php';" />
	<input type="button" value="Cliente Nuevo" onclick="window.location = 'clientes.php?OT=3'" />
    <input type="button" value="Lista de Clientes" onclick="window.location = 'clientes.php?mod=Lista&OT=3'" />
</div>
<div id="forma">
